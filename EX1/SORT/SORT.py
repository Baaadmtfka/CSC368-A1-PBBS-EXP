...
### Customize:
DEFAULT_BINARY = '/u/csc368h/winter/pub/workloads/pbbsbench/benchmarks/comparisonSort/sampleSort/sort'
# DEFAULT_BINARY = '/u/csc368h/winter/pub/workloads/pbbsbench/benchmarks/comparisonSort/serialSort/sort'
DEFAULT_INFILE = f"{ROOT_DIR}/sort-{SIZE}-input.txt"
DEFAULT_OUTFILE = f"{ROOT_DIR}/sort-{SIZE}-output.txt"
...
print(f'Finished SORT Benchmark, with input size: {SIZE*10}')
